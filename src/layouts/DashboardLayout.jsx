...
export default function DashBoardLayout() {
    ...
    return (
        <>
            <div className="bg-black fixed top-0 w-full z-20 text-lg text-white flex justify-end shadow-lg shadow-violet-300">
                <button className=" font-bold py-2 m-2 hover:bg-slate-800 bg-black duration-200 transition-all text-white border-2" ><Link className="py-4 px-4" to="/">To Home</Link></button>
            </div>
